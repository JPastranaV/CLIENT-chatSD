...
public class Main extends javax.swing.JFrame {
    ...
    private void open() {
        ...
        Method.setTextFieldSyle(txt, "Escriba un mensaje...");
        for (int i = 0; i < 10; i++) {
    ...
    private void initComponents() {
        ...
        spChat.setBackground(new java.awt.Color(255, 255, 255));
        ...
        panel_bg.add(spChat, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 590, 360));
        ...
        panelFriend.setBackground(new java.awt.Color(204, 204, 204));
        panelFriend.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        panel_bg.add(spFriend, new org.netbeans.lib.awtextra.AbsoluteConstraints(632, 40, 200, 360));
        ...
        panel_bg.add(txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 410, 500, 27));
        ...
        panel_bg.add(cmdSend, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 410, 43, -1));

        jLabel1.setFont(new java.awt.Font("Khmer SBBIC Serif", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Usuarios Activos");
        panel_bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 10, 120, -1));

        jLabel2.setFont(new java.awt.Font("Khmer SBBIC Serif", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Chat");
        panel_bg.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, 40, -1));
        ...
        panel_bg.add(cmdMore, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 410, -1, -1));
        ...
        panel_bg.add(cmdLogOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(632, 410, 200, 27));
        ...
        panel_bg.add(lbStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(543, 11, 300, 19));

        jLabel3.setDisabledIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/blur_bgrnd.jpg"))); // NOI18N
        jLabel3.setEnabled(false);
        panel_bg.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 480));

        getContentPane().add(panel_bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 480));

        pack();
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void setEmoji(Emoji_Group eg2) {
        panelEmoji.removeAll();
        for (int i = 1; i <= eg2.getIcons(); i++) {
            Emoji emo = new Emoji(eg2.getName() + " (" + i + ").png");
            emo.addActionListener(new ActionListener() {
        ...
        th = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (ms.equals("Socket Cerrado...")) {
                        signOut("Cerrar Sesión");
                    } else if (ms.equals("Conexión Reiniciada")) {
                        signOut("El servidor tiene un error...");
                    } else {
                        signOut("Error : " + ms);
                    }
    ...
    private void cmdLogOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdLogOutActionPerformed
        int c = JOptionPane.showConfirmDialog(this, "¿Está seguro de cerrar sesión?", "CERRAR SESIÓN", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    private void setImage() {
        ...
        if (c == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                showStatus("Error : No se puede enviar la foto");
            }
        }
    }
